...
SECRET_KEY = 'django-insecure-ter$b36-13%!8d&t1$woh!!k=f4^#4xbfs6$mlfq^_k3+2ou^^'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dev',
        'USER': 'dev_owner',
        'PASSWORD': 'npg_TlogjDP7h1RH',
        'HOST': 'ep-little-glitter-a50mtu96-pooler.us-east-2.aws.neon.tech',
        'PORT': 5432,
    }
}
